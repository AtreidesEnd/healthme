...
const TextFieldInput = ({value, onChange, id, name}) => {
  return (
    <div className="new-entry-form-textfield mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
      <label htmlFor="title" className="new-entry-text-label mdl-textfield__label">Title</label>
...
const TextAreaInput = ({value, onChange, id, name}) => {
  return (
    <div className="new-entry-form-textfield mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
      <label htmlFor="desc" className="new-entry-text-label mdl-textfield__label">Description</label>
